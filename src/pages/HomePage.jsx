...
const Flor = ({ className }) => (
  <svg className={className} viewBox="0 0 200 200" aria-hidden="true">
    ...
    <circle cx="100" cy="100" r="34" fill="#FFD100" />
    <circle cx="100" cy="100" r="17" fill="#003DA5" />
  </svg>
)
...
const SvgMision = (
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    ...
    <g transform="translate(650,200)">
      ...
      <path d="M-10 290 L150 130" stroke="#FFD100" strokeWidth="14" strokeLinecap="round" />
      <path d="M120 130 h34 v34" fill="none" stroke="#FFD100" strokeWidth="14" strokeLinecap="round" strokeLinejoin="round" />
    </g>
  </svg>
)
  ...
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    <defs>
      <linearGradient id="g-vis" x1="0" y1="0" x2="1" y2="1">
        ...
        <stop offset="1" stopColor="#003DA5" />
      </linearGradient>
    </defs>
    ...
    <g transform="translate(620,230)">
      ...
      <circle cx="180" cy="90" r="54" fill="#003DA5" />
      <circle cx="180" cy="90" r="26" fill="#FFD100" />
...
const SvgLavado = (
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    ...
    <g transform="translate(700,360)">
      ...
      <path d="M52 98 l24 24 l44 -56" fill="none" stroke="#FFD100" strokeWidth="13" strokeLinecap="round" strokeLinejoin="round" />
    </g>
  </svg>
)
  ...
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    <defs>
      <linearGradient id="g-pad" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#003DA5" />
        <stop offset="0.55" stopColor="#FFD100" />
        <stop offset="1" stopColor="#003DA5" />
      </linearGradient>
    </defs>
    ...
    <g transform="translate(700,360)">
      ...
      <rect x="80" y="70" width="30" height="120" fill="#FFD100" />
      <rect x="-4" y="48" width="198" height="34" rx="8" fill="#ffffff" />
      <rect x="80" y="48" width="30" height="34" fill="#FFD100" />
...
const SvgBandera = (
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    ...
    <g transform="translate(700,250)">
      <rect x="0" y="0" width="10" height="230" rx="5" fill="#FFD100" />
      <circle cx="5" cy="0" r="9" fill="#FFD100" />
      <path d="M10 14 h70 v120 h-70 Z" fill="#003DA5" />
      <path d="M80 14 h70 v120 h-70 Z" fill="#ffffff" />
      <path d="M150 14 h70 v120 h-70 Z" fill="#003DA5" />
    </g>
  </svg>
)
...
const SvgMetas = (
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    ...
    <g transform="translate(700,360)">
      ...
      <path d="M10 70 L80 40 L140 12" fill="none" stroke="#FFD100" strokeWidth="8" strokeLinecap="round" />
      <path d="M120 12 h26 v26" fill="none" stroke="#FFD100" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
    </g>
  </svg>
)
